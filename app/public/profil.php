<?php
session_start(); // Assurez-vous que session_start() est en haut du fichier
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Vérifier si les expériences et l'éducation sont définies avant de les traiter
    $experiences = isset($_POST['experiences']) ? array_map('htmlspecialchars', $_POST['experiences']) : [];
    $education = isset($_POST['education']) ? array_map('htmlspecialchars', $_POST['education']) : [];
...
<form method="POST" action="" class="container mt-5">
    ...
    <div id="experiences-section" class="form-group">
        ...
        <div class="experience-item mb-3">
            ...
            <textarea name="experiences[]" class="form-control mb-2"></textarea>
    ...
    <div id="education-section" class="form-group">
        ...
        <div class="education-item mb-3">
            ...
            <textarea name="education[]" class="form-control mb-2"></textarea>
